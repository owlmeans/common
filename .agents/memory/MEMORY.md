...
- [[payments]] `packages/{payment,server-payment,client-payment,web-payment}/**` — ranked plans + free plan; capabilities vs limits; admission-first usage ledger; amount gross-up
