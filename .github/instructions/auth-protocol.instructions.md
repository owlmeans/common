---
applyTo: "packages/{auth,auth-common,basic-keys,basic-envelope,did,client-auth,client-did,server-auth,oidc,server-oidc-rp,server-oidc-provider,web-oidc-rp,web-oidc-provider,wled,client-payment}/src/**"
---
