---
description: "How to manage package versions in the OwlMeans Common monorepo. All packages are synchronized at the same version. Use when bumping versions, checking the current version, or updating internal dependency references."
