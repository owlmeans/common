...
- `.github/instructions/shadcn-web.instructions.md` — full development & maintenance guide
- `.github/instructions/shadcn-versions.instructions.md` — updating UI lib versions
- `.github/instructions/testing-ui.instructions.md` — updated for Tailwind + `@` alias harness
