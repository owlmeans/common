...
**Install:** `"@owlmeans/agent-skills": "^0.1.18-rc.21"` — in `devDependencies` for the CLI, in
...
`npx @owlmeans/agent-skills@^0.1.18-rc.21` walks the **whole** project tree, reads every nested
