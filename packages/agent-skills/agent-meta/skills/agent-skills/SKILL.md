...
**Install:** `"@owlmeans/agent-skills": "^0.1.18-rc.35"` — in `devDependencies` for the CLI, in
...
`npx @owlmeans/agent-skills@^0.1.18-rc.35` walks the **whole** project tree, reads every nested
