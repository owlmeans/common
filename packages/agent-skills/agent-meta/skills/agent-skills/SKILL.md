...
**Install:** `"@owlmeans/agent-skills": "^0.1.18-rc.36"` — in `devDependencies` for the CLI, in
...
`npx @owlmeans/agent-skills@^0.1.18-rc.36` walks the **whole** project tree, reads every nested
