        ...
        case AuthenticationStage.Init: {
          ...
          if (hasState) {
            ...
            if (code != null) {
              ...
              // A device or authorization-code consent screen may have suspended itself here
              // before sending the browser to sign in; resuming it takes priority over the app's
              // own home.
